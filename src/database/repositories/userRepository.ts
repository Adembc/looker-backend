...
export default class UserRepository {
  ...
  public static async createUser(data: object): Promise<user | null> {
    return await User.create(data);
  }
  public static async findAllUser(data = {}): Promise<user[] | null> {
  ...
  public static async saveUser(user: user): Promise<user | null> {
